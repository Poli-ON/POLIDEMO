function eta_plating=get_eta_plating(ur,jn_int)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% GET_ETA_PLATING
% This function computes the overpotential associated with lithium plating
% at the anode.
%
...
%
% OUTPUTS
% eta_plating : Lithium plating overpotential
%
...
eta_plating = eta_n+U_n-param.U_plating;
end